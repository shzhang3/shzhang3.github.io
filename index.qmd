...
::: {.project-feature}
::: {.project-media}
[![](assets/guidance-stability-lab-preview.jpg){.project-preview fig-alt="Guidance Stability Lab comparing vanilla CFG, fitted CFG, and terminal guidance shutdown on matched Stable Diffusion samples"}](https://shzhang3.github.io/guidance-stability-lab/)
:::

::: {.project-copy}
<p class="project-kicker">Research engineering portfolio · 2026</p>

### Guidance Stability Lab

<p class="project-summary">An interactive matched-seed laboratory that turns a numerical-analysis result for classifier-free guidance into inspectable software. It combines exact denoising traces, clipping diagnostics, and audited CIFAR-10 and Stable Diffusion evidence.</p>

::: {.project-evidence}
<div><strong>1 coefficient</strong><span>changed in the sampler</span></div>
<div><strong>Same NFE</strong><span>prompt, seed, and network fixed</span></div>
<div><strong>Audited</strong><span>data contracts and browser tests</span></div>
:::

::: {.project-actions}
[Open interactive lab](https://shzhang3.github.io/guidance-stability-lab/){.action-button .action-primary}
[View source](https://github.com/shzhang3/guidance-stability-lab){.action-button .action-secondary}
:::
:::
:::
:::
...
Shiheng Zhang and Jingwei Hu · ESAIM: M2AN, forthcoming article · [PDF](https://www.esaim-m2an.org/articles/m2an/pdf/forth/m2an260029.pdf)
:::
:::
